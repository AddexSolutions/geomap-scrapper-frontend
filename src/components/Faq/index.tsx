...
const Faq = () => {
  return (
    <section className="relative z-20 overflow-hidden bg-white pb-[100px] pt-20 sm:pt-10 dark:bg-dark">
      <div className="container">
        <SectionTitle
          subtitle="FAQ"
          title="Got Questions? We&apos;ve Got Answers"
          paragraph="GMaps Scraper makes data extraction easy and affordable. Find answers to common questions here."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="How does GMaps Scraper work?"
              answer="It extracts business data, contacts, and leads from Google Maps in seconds."
            />
            <SingleFaq
              question="Which data can I extract?"
              answer="You can scrape business names, addresses, phone numbers, websites, and more."
            />
            <SingleFaq
              question="Is coding required to use it?"
              answer="No, GMaps Scraper is a no-code tool—just enter your search, and extract data."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="Can I export scraped data?"
              answer="Yes, you can download data in CSV, Excel, or JSON format for easy use."
            />
            <SingleFaq
              question="Is GMaps Scraper affordable?"
              answer="Yes! We offer the lowest pricing compared to competitors, making data extraction budget-friendly."
            />
            <SingleFaq
              question="Is it legal to scrape Google Maps?"
              answer="Scraping public data is allowed, but always comply with Google’s policies."
            />
          </div>
        </div>
      </div>
      ...
      <div>
        <span className="hidden sm:block absolute left-4 top-4 -z-[1]">
          <svg
            width="48"
            height="134"
            viewBox="0 0 48 134"
