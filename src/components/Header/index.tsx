          ...
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4">
              <Link href="/" className={`navbar-logo block w-full ${sticky ? "py-2" : "py-5"} `}>
                <>
                  <span className={`${sticky && pathUrl === '/' && 'text-slate-700 font-medium'} ${!sticky && pathUrl === '/' && 'text-white font-semibold'} ${pathUrl !== '/' && 'text-slate-700 font-medium'} whitespace-nowrap header-logo w-full text-2xl sm:text-3xl dark:hidden`}>
                    GMaps-Scraper
                  </span>
                  <span className="whitespace-nowrap header-logo w-full text-3xl text-white font-semibold hidden dark:block">
                    GMaps-Scraper
                  </span>
                </>
              </Link>
            ...
            <div>
              ...
              >
                <ul className="block lg:ml-8 lg:flex lg:mx-auto lg:gap-x-8 xl:ml-14 xl:gap-x-12">
